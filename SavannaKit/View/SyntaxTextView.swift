...
open class SyntaxTextView: PlatformView {
  ...
  public var contentTextView: PlatformTextView {
    return textView
  }
  ...
  func createAttributes(theme: SyntaxColorTheme, themeInfo: ThemeInfo, textStorage: NSTextStorage, cachedTokens: [CachedToken], source: String) {
    ...
    for cachedToken in cachedTokens {
      ...
      if token.isEditorPlaceholder {
        ...
        textStorage.addAttributes([.foregroundColor: PlatformColor.clear, .font: PlatformFont.systemFont(ofSize: 0.01)], range: startRange)
        textStorage.addAttributes([.foregroundColor: PlatformColor.clear, .font: PlatformFont.systemFont(ofSize: 0.01)], range: endRange)

  ...
  convenience init(source: String, tokens: [Token], theme: SyntaxColorTheme) {
    ...
    var attributes = [NSAttributedString.Key: Any]()
        ...
        var attr = [NSAttributedString.Key: Any]()
				...
				self.addAttributes([.foregroundColor: PlatformColor.clear, .font: PlatformFont.systemFont(ofSize: 0.01)], range: startRange)
				self.addAttributes([.foregroundColor: PlatformColor.clear, .font: PlatformFont.systemFont(ofSize: 0.01)], range: endRange)
